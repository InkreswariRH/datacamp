...
#       fur_color = "blonde'
# Someone at the police station made an error when filling out the final lines of Bayes' Missing Puppy Report.
# In this exercise, you will correct the errors.
